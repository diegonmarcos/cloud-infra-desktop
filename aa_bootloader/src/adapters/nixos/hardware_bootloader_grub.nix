...
in {
  boot.loader.grub = {
    ...
    extraInstallCommands = ''
      ...
      # ═══════════════════════════════════════════════════════════════════════
      # aa_bootloader Phase 3b hook
      # ═══════════════════════════════════════════════════════════════════════
      # NixOS just wrote /boot/grub/grub.cfg via its own templating. Overwrite
      # it with aa_bootloader's SoT-rendered version (multi-OS + auto-walked
