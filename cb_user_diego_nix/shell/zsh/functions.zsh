#!/bin/zsh
# =============================================================================
# ZSH FUNCTIONS - Comprehensive function definitions
...
show_functions() {
    ...
    echo ""
    echo "  C Development (zsh only):"
    echo "  c, cx, cv      - Compile/execute/valgrind"
    echo "  cl, clx, clv   - Compile with library"
    echo "  cdb, cldb      - Debug with lldb/gdb"
}
