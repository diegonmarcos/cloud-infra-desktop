...
#        ~/git/cloud-infra-desktop/1_reports/claude--debug.log    (mirror, committed + pushed —
...
UNIX_REPORT_DIR="$HOME/git/cloud-infra-desktop/1_reports"
