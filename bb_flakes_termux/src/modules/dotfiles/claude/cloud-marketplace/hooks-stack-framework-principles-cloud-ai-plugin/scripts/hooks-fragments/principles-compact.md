...
Full reference: read /home/diego/.claude/cloud-marketplace/hooks-stack-framework-principles-cloud-ai-plugin/scripts/hooks-fragments/reference.md (plus core-principles.md, fire-rules.md, stack-philosophy.md, pre-action-checklist.md, forbidden-patterns.md, dead-shell-recovery.md in the same dir) for full detail.
