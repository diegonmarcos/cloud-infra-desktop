...
[Service]
Type=oneshot
ExecStart=/home/user/mnt_git/cloud-infra-desktop/b_mnt/mount.sh start
ExecStop=/home/user/mnt_git/cloud-infra-desktop/b_mnt/mount.sh stop
RemainAfterExit=yes
...
# Commit any changes
cd ~/mnt_git/cloud-infra-desktop && git status
