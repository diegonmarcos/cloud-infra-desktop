...
class FloatingNavService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        // Standard notification actions: white ic_nav_* icon + text label per
        // action — the original Quick Actions UI. (A custom centered-icon
        // RemoteViews layout was tried but dropped the labels; the labelled
        // standard actions are what the user wants.) Android shows the first
        // compact_action_count in the collapsed view via MediaStyle; the
        ...
        b.setStyle(androidx.media.app.NotificationCompat.MediaStyle()
