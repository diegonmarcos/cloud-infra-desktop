...
(local and CI), on top of a fresh network clone of upstream Fossify Phone.

As of 2026-08-19, `materialize-fork` no longer clones or applies these — the fully
patched source is vendored directly in `ea_cloud-dialer/upstream/` (committed, no
...
Making a new change: edit `ea_cloud-dialer/upstream/` directly, then (optional but
