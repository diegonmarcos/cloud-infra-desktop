...
run_tui() {
    ...
    printf "\n"
    printf "${CYAN}╔═══════════════════════════════════════════════════════╗${NC}\n"
    printf "${CYAN}║${NC}  ${BOLD}CLI Dev Container${NC}  ${DIM}($ENGINE)${NC}                        ${CYAN}║${NC}\n"
    printf "${CYAN}╚═══════════════════════════════════════════════════════╝${NC}\n"
    printf "\n"
    ...
    printf "  ${CYAN}4${NC}) Enter shell           ${DIM}(fish)${NC}\n"
...
Usage:
  ...
  ./build.sh enter        Enter container shell (fish)
  ./build.sh export       Export image to .tar
