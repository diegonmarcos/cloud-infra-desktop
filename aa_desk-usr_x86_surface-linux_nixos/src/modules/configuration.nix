...

{
  ...
  imports = [
    ...
    ./configuration_redroid.nix                    # POST-2026-07-02: Redroid (containerized Android) host prereqs — binder module + scrcpy/adb. Replaces the removed Waydroid host glue. Container itself is on-demand via ~/git/cloud-unix/da_redroid/build.sh (never auto-started).
