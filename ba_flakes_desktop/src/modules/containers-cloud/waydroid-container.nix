...
# data-driven engine at ~/git/cloud-infra-desktop/af_waydroid-container/build.sh. The image is built
...
{ config, pkgs, lib, ... }:
let
  engine = "$HOME/git/cloud-infra-desktop/af_waydroid-container/build.sh";
