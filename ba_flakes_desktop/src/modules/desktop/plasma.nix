...

{
  ...
  # to ~/.local/share/plasma/plasmoids/. `recursive = true` symlinks each
  # file individually (Plasma tolerates the /nix/store QML symlinks).
  xdg.dataFile."plasma/plasmoids/org.kde.plasma.kstats" = {
    source = ../dotfiles/kde/plasmoids/org.kde.plasma.kstats;
    recursive = true;
  };
