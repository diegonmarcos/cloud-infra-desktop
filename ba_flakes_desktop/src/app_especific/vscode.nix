...

{
  programs.vscode = {
    ...
    # userSettings/keybindings/extensions moved under profiles.default in
    # home-manager 25.05; the flat names still work as aliases but warn on
    # every switch and will be dropped.
    profiles.default = {
      userSettings = {
        # Git
