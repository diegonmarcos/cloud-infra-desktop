#!/bin/zsh
# =============================================================================
# ZSH STARTUP - Welcome screen with system info
# Source: shell/zsh/startup.zsh
# =============================================================================
...
_show_quick_ref() {
    ...
    echo -e "  ${_YELLOW}Navigation:${_RST}  ..  ...  ....  mkcd <dir>  1-5 (popd)"
    echo -e "  ${_YELLOW}Listing:${_RST}     ll  la  lh  lt"
    echo -e "  ${_YELLOW}Git:${_RST}         gs  ga  gc  gp  gl  gd  gcam  gpsh  push"
    ...
    echo -e "  ${_YELLOW}C Dev:${_RST}       cx  cv  clx  clv  cldb  myhelp_c"
...
_show_welcome() {
    ...
    # Header
    echo -e "${_BOLD}${_BLUE}Welcome to Zsh, $(whoami)!${_RST}"
