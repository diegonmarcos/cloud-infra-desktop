{
  description = "Diego Cloud Contacts — Nix devShell wrapping the Android Gradle build (gradle + AGP + Android SDK + JDK 17). All toolchain pinned; same input → same APK.";
      ...
      in {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "[cloud-contacts devshell] ANDROID_HOME=$ANDROID_HOME"
          '';
        };

        devShells.emulator = pkgs.mkShell {
          name = "cloud-contacts-emulator-devshell";
