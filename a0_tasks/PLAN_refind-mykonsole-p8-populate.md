...
**Executor**: build agent (sonnet). Repos: `~/git/cloud-infra-desktop`, main branch, direct push.
...
(`my-konsole-iso`, repo diegonmarcos/cloud-infra-desktop); `build.sh install-partition` in
...
2. Run the engine verb: `cd ~/git/cloud-infra-desktop/ca_ventoy_fallback_usb/my-konsole &&
