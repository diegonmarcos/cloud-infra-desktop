...
Evidence: `/loot/20260502T163641Z/local/tier1/ss-listen/ss-listen.txt`
...
Evidence: `/loot/20260502T163641Z/local/wifi/iw-survey/wifi-survey.txt`

### 🟠 **MEDIUM** — nmap-vulners flagged 10 CVE references on localhost services
Inspect /loot/20260502T163641Z/local/tier2/nmap-localhost-vuln/nmap-localhost.stdout. Each CVE = junior pentester googles + runs the public PoC.
Evidence: `/loot/20260502T163641Z/local/tier2/nmap-localhost-vuln/nmap-localhost.stdout`
...
Evidence: `/loot/20260502T163641Z/local/tier2/searchsploit-kernel/searchsploit.json`

## Tier 4 — Expert / kernel / container escape

### 🔵 **INFO** — Kernel side-channel mitigations: 5 active
Spectre/Meltdown/L1TF/MDS family. `cat /loot/20260502T163641Z/local/tier2/kernel-mitigations/mitigations.txt` for the full breakdown.
Evidence: `/loot/20260502T163641Z/local/tier2/kernel-mitigations/mitigations.txt`

### 🔵 **INFO** — 297 kernel modules loaded
Each loaded module is potential attack surface. Compare to baseline / pkg-list.
Evidence: `/loot/20260502T163641Z/local/tier3/loaded-modules/lsmod.txt`

## Raw loot

`/loot/20260502T163641Z`
